...
Write-Host "   kubectl logs -f -l app=todo-chatbot-backend -n todo-app" -ForegroundColor White
Write-Host "   kubectl logs -f -l app=todo-chatbot-frontend -n todo-app" -ForegroundColor White
Write-Host ""
Write-Host "🧹 To cleanup later:" -ForegroundColor Yellow
Write-Host "   helm uninstall todo-chatbot -n todo-app" -ForegroundColor White
